...
## Project Structure
    ...
    ├── testdfdeaswrgy_dev_60792  # Django project configurations
...
1. Clone this repo and `cd testdfdeaswrgy_dev_60792`
...
2. Clone this repo and `cd testdfdeaswrgy_dev_60792`
